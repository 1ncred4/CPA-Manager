      ...
      <div className={styles.layout}>
        <Card className={styles.aboutCard}>
          <div className={styles.aboutHeader}>
            <img src={catAvatar} alt="CPA-Manager" className={styles.aboutLogo} />
            <div className={styles.aboutText}>
              <div className={styles.aboutTitle}>{t('system_info.about_title')}</div>
              <div className={styles.aboutSubtitle}>{t('system_info.about_subtitle')}</div>
            </div>
          </div>
        ...
        <Card className={styles.clearCard}>
          <div className={styles.clearLoginRow}>
            <div className={styles.clearLoginText}>
              <div className={styles.clearLoginTitle}>{t('system_info.clear_login_title')}</div>
              <p className={styles.clearLoginDesc}>{t('system_info.clear_login_desc')}</p>
            </div>
